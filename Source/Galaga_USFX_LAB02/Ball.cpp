...
ABall::ABall()
{
	...
	static ConstructorHelpers::FObjectFinder<UMaterialInstance> MaterialBall(TEXT("MaterialInstanceConstant'/Game/TwinStick/Meshes/OrangeMaterial_2.OrangeMaterial_2'"));
...
void ABall::Launch()
{
	...
	if (!BallLaunched) 
	{
		SM_Ball->AddImpulse(FVector(600.0f, 300.0f, 0.0f), FName(), true);
		BallLaunched = true;
